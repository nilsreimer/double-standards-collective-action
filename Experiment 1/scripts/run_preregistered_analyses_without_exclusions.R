...
# Estimate ----------------------------------------------------------------
  ...
  # Save results as .rds
  fit$save_object("Experiment 1/results/fit_pregistered_analyses_without_exclusions.rds")


# Predict -----------------------------------------------------------------
  
  # Import results
  fit <- read_rds("Experiment 1/results/fit_pregistered_analyses_without_exclusions.rds")
...
# Export ------------------------------------------------------------------
  ...
  # Save sample as .rds
  write_rds(post, "Experiment 1/results/results_pregistered_analyses_without_exclusions.rds")
