...
# Estimate (Model 1) ------------------------------------------------------
  ...
  # Save results as .rds
  m1_fit$save_object("Experiment 2/results/m1_fit_without_exclusions.rds")
...
# Estimate (Model 2) ------------------------------------------------------
  ...
  # Save results as .rds
  m2_fit$save_object("Experiment 2/results/m2_fit_without_exclusions.rds")
...
# Estimate (Model 3) ------------------------------------------------------
  ...
  # Save results as .rds
  m3_fit$save_object("Experiment 2/results/m3_fit_without_exclusions.rds")
  

# Process (Model 1) -------------------------------------------------------

  # Import results
  m1_fit <- read_rds("Experiment 2/results/m1_fit_without_exclusions.rds")
  ...
  write_rds(m1_post, "Experiment 2/results/m1_post_without_exclusions.rds")
  

# Process (Model 2) -------------------------------------------------------
  
  # Import results
  m2_fit <- read_rds("Experiment 2/results/m2_fit_without_exclusions.rds")
  ...
  # Export results as .rds
  write_rds(m2_post, "Experiment 2/results/m2_post_without_exclusions.rds")
  

# Process (Model 3) -------------------------------------------------------
  
  # Import results
  m3_fit <- read_rds("Experiment 2/results/m3_fit_without_exclusions.rds")
  ...
  # Export results as .rds
  write_rds(m3_post, "Experiment 2/results/m3_post_without_exclusions.rds")
