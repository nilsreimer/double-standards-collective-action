...
# Estimate ----------------------------------------------------------------
  ...
  # Save results
  fit$save_object("Experiment 1/results/fit_exploratory_analyses.rds")
  

# Predict -----------------------------------------------------------------

  # Import results
  fit <- read_rds("Experiment 1/results/fit_exploratory_analyses.rds")
...
# Export ------------------------------------------------------------------
  ...
  # Save sample as .rds
  write_rds(post, "Experiment 1/results/results_exploratory_analyses.rds")
