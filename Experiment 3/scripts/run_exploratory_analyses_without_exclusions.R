...
# Estimate (Gender Identification) ----------------------------------------
  ...
  # Save results as .rds
  ide_fit$save_object("Experiment 3/results/ide_fit_without_exclusions.rds")
  

# Process (Gender Identification) -----------------------------------------

  # Import results
  ide_fit <- read_rds("Experiment 3/results/ide_fit_without_exclusions.rds")
  ...
  write_rds(ide_post, "Experiment 3/results/ide_post_without_exclusions.rds")
...
# Estimate (System Justification) -----------------------------------------
  ...
  # Save results as .rds
  sjb_fit$save_object("Experiment 3/results/sjb_fit_without_exclusions.rds")


# Process (System Justification)  -----------------------------------------

  # Import results
  sjb_fit <- read_rds("Experiment 3/results/sjb_fit_without_exclusions.rds")
  ...
  # Export results as .rds
  write_rds(sjb_post, "Experiment 3/results/sjb_post_without_exclusions.rds")
