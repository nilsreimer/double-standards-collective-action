...
# Prepare -----------------------------------------------------------------
  ...
  d_prereg <- read_rds("Experiment 1/results/results_pregistered_analyses_without_exclusions.rds")
  
  # Import results (exploratory analyses)
  d_explor <- read_rds("Experiment 1/results/results_exploratory_analyses_without_exclusions.rds")
...
# Export ------------------------------------------------------------------
  ...
  # Export as .png
  ggsave(
    "Experiment 1/figures/figure-s2.png",
    width = 6.5, height = 6.5/3*2, units = "in", dpi = 600
  )
  
  # Export as .pdf
  ggsave(
    "Experiment 1/figures/figure-s2.pdf",
    width = 6.5, height = 6.5/3*2, units = "in", dpi = 600
  )  
